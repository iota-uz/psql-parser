...
import (
	...
	"github.com/iota-uz/psql-parser/sql/pgwire/pgerror"
...
type Expr interface {
	...
	// to type checking.
	TypeCheck(ctx *SemaContext, desired *types2.T) (TypedExpr, error)
}
...
func (ta typeAnnotation) ResolvedType() *types2.T {
	ta.assertTyped()
	return ta.typ
}
...
func NewTypedIndirectionExpr(expr, index TypedExpr, typ *types2.T) *IndirectionExpr {
...
func NewTypedCollateExpr(expr TypedExpr, locale string) *CollateExpr {
	...
	node.typ = types2.MakeCollatedString(types2.String, locale)
	return node
}
...
func NewTypedArrayFlattenExpr(input Expr) *ArrayFlatten {
	...
	node.typ = types2.MakeArray(inputTyp)
	return node
}
...
func NewTypedCoalesceExpr(typedExprs TypedExprs, typ *types2.T) *CoalesceExpr {
	c := &CoalesceExpr{
		Name:  "COALESCE",
...
func NewTypedArray(typedExprs TypedExprs, typ *types2.T) *Array {
	c := &Array{
		Exprs: make(Exprs, len(typedExprs)),
	}
	for i := range typedExprs {
...
func (DefaultVal) ResolvedType() *types2.T { return nil }
...
// ResolvedType implements the TypedExpr interface.
func (node *Placeholder) ResolvedType() *types2.T {
	if node.typ == nil {
		return types2.Any
	}
	return node.typ
...
func NewTypedTuple(typ *types2.T, typedExprs Exprs) *Tuple {
	return &Tuple{
		Exprs:  typedExprs,
...
// ResolvedType implements the TypedExpr interface.
func (node *Tuple) ResolvedType() *types2.T {
	return node.typ
}
...
func (node *Array) Format(ctx *FmtCtx) {
	...
	if ctx.HasFlags(FmtParsable) && node.typ != nil {
		if node.typ.ArrayContents().Family() != types2.UnknownFamily {
			ctx.WriteString(":::")
...
func (node *Subquery) SetType(t *types2.T) {
	node.typ = t
}
...
func (node *TypedDummy) Format(ctx *FmtCtx) {
	...
	ctx.WriteString(node.Typ.SQLString())
	ctx.WriteString(")")
}

// ResolvedType implements the TypedExpr interface.
func (node *TypedDummy) ResolvedType() *types2.T {
	return node.Typ
}

// TypeCheck implements the Expr interface.
func (node *TypedDummy) TypeCheck(*SemaContext, *types2.T) (TypedExpr, error) {
	return node, nil
}
...
func NewTypedBinaryExpr(op BinaryOperator, left, right TypedExpr, typ *types2.T) *BinaryExpr {
...
func NewTypedUnaryExpr(op UnaryOperator, expr TypedExpr, typ *types2.T) *UnaryExpr {
...
func (node *FuncExpr) Format(ctx *FmtCtx) {
	...
	if ctx.HasFlags(FmtParsable) && node.typ != nil {
		if node.fnProps.AmbiguousReturnType {
			...
			if node.typ.Family() != types2.TupleFamily {
				ctx.WriteString(":::")
				ctx.Buffer.WriteString(node.typ.SQLString())
			}
		}
...
func NewTypedCaseExpr(
	expr TypedExpr, whens []*When, elseStmt TypedExpr, typ *types2.T,
) (*CaseExpr, error) {
...
func NewTypedCastExpr(expr TypedExpr, typ *types2.T) (*CastExpr, error) {
...
var (
	bitArrayCastTypes = annotateCast(types2.VarBit, []*types2.T{types2.Unknown, types2.VarBit, types2.Int, types2.String, types2.AnyCollatedString})
	boolCastTypes     = annotateCast(types2.Bool, []*types2.T{types2.Unknown, types2.Bool, types2.Int, types2.Float, types2.Decimal, types2.String, types2.AnyCollatedString})
	intCastTypes      = annotateCast(types2.Int, []*types2.T{types2.Unknown, types2.Bool, types2.Int, types2.Float, types2.Decimal, types2.String, types2.AnyCollatedString,
		types2.Timestamp, types2.TimestampTZ, types2.Date, types2.Interval, types2.Oid, types2.VarBit})
	floatCastTypes = annotateCast(types2.Float, []*types2.T{types2.Unknown, types2.Bool, types2.Int, types2.Float, types2.Decimal, types2.String, types2.AnyCollatedString,
		types2.Timestamp, types2.TimestampTZ, types2.Date, types2.Interval})
	decimalCastTypes = annotateCast(types2.Decimal, []*types2.T{types2.Unknown, types2.Bool, types2.Int, types2.Float, types2.Decimal, types2.String, types2.AnyCollatedString,
		types2.Timestamp, types2.TimestampTZ, types2.Date, types2.Interval})
	stringCastTypes = annotateCast(types2.String, []*types2.T{types2.Unknown, types2.Bool, types2.Int, types2.Float, types2.Decimal, types2.String, types2.AnyCollatedString,
		types2.VarBit,
		types2.AnyArray, types2.AnyTuple,
		types2.Bytes, types2.Timestamp, types2.TimestampTZ, types2.Interval, types2.Uuid, types2.Date, types2.Time, types2.TimeTZ, types2.Oid, types2.INet, types2.Jsonb})
	bytesCastTypes = annotateCast(types2.Bytes, []*types2.T{types2.Unknown, types2.String, types2.AnyCollatedString, types2.Bytes, types2.Uuid})
	dateCastTypes  = annotateCast(types2.Date, []*types2.T{types2.Unknown, types2.String, types2.AnyCollatedString, types2.Date, types2.Timestamp, types2.TimestampTZ, types2.Int})
	timeCastTypes  = annotateCast(types2.Time, []*types2.T{types2.Unknown, types2.String, types2.AnyCollatedString, types2.Time, types2.TimeTZ,
		types2.Timestamp, types2.TimestampTZ, types2.Interval})
	timeTZCastTypes    = annotateCast(types2.TimeTZ, []*types2.T{types2.Unknown, types2.String, types2.AnyCollatedString, types2.Time, types2.TimeTZ, types2.TimestampTZ})
	timestampCastTypes = annotateCast(types2.Timestamp, []*types2.T{types2.Unknown, types2.String, types2.AnyCollatedString, types2.Date, types2.Timestamp, types2.TimestampTZ, types2.Int})
	intervalCastTypes  = annotateCast(types2.Interval, []*types2.T{types2.Unknown, types2.String, types2.AnyCollatedString, types2.Int, types2.Time, types2.Interval, types2.Float, types2.Decimal})
	oidCastTypes       = annotateCast(types2.Oid, []*types2.T{types2.Unknown, types2.String, types2.AnyCollatedString, types2.Int, types2.Oid})
	uuidCastTypes      = annotateCast(types2.Uuid, []*types2.T{types2.Unknown, types2.String, types2.AnyCollatedString, types2.Bytes, types2.Uuid})
	inetCastTypes      = annotateCast(types2.INet, []*types2.T{types2.Unknown, types2.String, types2.AnyCollatedString, types2.INet})
	arrayCastTypes     = annotateCast(types2.AnyArray, []*types2.T{types2.Unknown, types2.String})
	jsonCastTypes      = annotateCast(types2.Jsonb, []*types2.T{types2.Unknown, types2.String, types2.Jsonb})
)

// validCastTypes returns a set of types that can be cast into the provided type.
func validCastTypes(t *types2.T) []castInfo {
	switch t.Family() {
	...
	case types2.TimestampFamily, types2.TimestampTZFamily:
