...
import (
	...
	"github.com/iota-uz/psql-parser/util/leaktest"
	"testing"
)
...
func TestNormalizeExpr(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer tree2.MockNameTypes(map[string]*types.T{
		"a":  types.Int,
		"b":  types.Int,
		"c":  types.Int,
		"d":  types.Bool,
