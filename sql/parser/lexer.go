...
import (
	...
	unimp "github.com/iota-uz/psql-parser/util/errorutil/unimplemented"
	"strings"
...
func (l *lexer) PurposelyUnimplemented(feature string, reason string) {
	...
	l.lastError = errors.WithHint(
		errors.WithTelemetry(
			pgerror2.Newf(pgcode.Syntax, "unimplemented: this syntax"),
...
func (l *lexer) setErr(err error) {
	err = pgerror2.WithCandidateCode(err, pgcode.Syntax)
	l.lastError = err
	l.populateErrorDetails()
}
...
func (l *lexer) Error(e string) {
	...
	l.lastError = pgerror2.WithCandidateCode(errors.New(e), pgcode.Syntax)
	l.populateErrorDetails()
}
...
func (l *lexer) populateErrorDetails() {
	...
	if lastTok.id == ERROR {
		...
		err := pgerror2.WithCandidateCode(errors.Newf("lexical error: %s", lastTok.str), pgcode.Syntax)
...
func (l *lexer) SetHelp(msg HelpMessage) {
	if l.lastError == nil {
		l.lastError = pgerror2.WithCandidateCode(errors.New("help request"), pgcode.Syntax)
	}
