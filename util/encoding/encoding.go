...
// the supplied buffer, and returns the final buffer.
func EncodeUUIDValue(appendTo []byte, colID uint32, u uuid2.UUID) []byte {
...
// and returns the final buffer.
func EncodeUntaggedUUIDValue(appendTo []byte, u uuid2.UUID) []byte {
...
var _ [uuidValueEncodedLength]byte = uuid2.UUID{} // Assert that uuid.UUID is length 16.

// DecodeUUIDValue decodes a value encoded by EncodeUUIDValue.
func DecodeUUIDValue(b []byte) (remaining []byte, u uuid2.UUID, err error) {
...
func DecodeUntaggedUUIDValue(b []byte) (remaining []byte, u uuid2.UUID, err error) {
	u, err = uuid2.FromBytes(b[:uuidValueEncodedLength])
	if err != nil {
		return b, uuid2.UUID{}, err
	}
